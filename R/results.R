...
get_results <- function() {
    cli::cli_progress_step("now loading data", "loading done", "loading failed")
    suppressMessages({
        weights <- path_input_data("Co_author_weightings.csv") |>
            readr::read_csv(show_col_types = FALSE)
        data6 <- path_output_data("watershed_prioritization_level6.csv") |>
            readr::read_csv(show_col_types = FALSE)
    ...
    ###########
    cli::cli_progress_step("now scaling", "scaling done", "scaling failed")
    ...
    ##########
    cli::cli_progress_step("now drawing fig 1", "fig 1 done", "fig 1 failed")
    ...
    ggpubr::ggarrange(p1, p2, p3, p4, ncol = 2, nrow = 2) # Write the grid.arrange in the file
    ggsave(path_output_fig("coauthor_weightings.png"), width = 12, height = 8.5, units = "in", dpi = 100)
    cli::cli_progress_done()
    ...
    ggsave(path_output_fig("normalized_index_values.png"), width = 7.5, height = 9, units = "in", dpi = 100) # Open a new png file
    cli::cli_progress_done()
    ...
    ggsave(path_output_fig("national_priorities.png"), width = 8.5, height = 6, units = "in", dpi = 100) # Open a new png file
    cli::cli_progress_done()
    ...
    ggsave(path_output_fig("protection_vs_restoration.png"), width = 8.5, height = 4, units = "in", dpi = 100) # Open a new png file
    cli::cli_progress_done()
    ...
    ggsave(path_output_fig("SAR_vs_AIS.png"), width = 8.5, height = 4, units = "in", dpi = 100)
